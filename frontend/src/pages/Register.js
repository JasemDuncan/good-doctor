          ...
          <section className="row">
            <div className="col-5 mx-auto">
              <section className="bg-light mb-5 p-5">
                ...
                <div className="mb-3">
                  <input id="name" name="fullName" className="form-control" placeholder="Your Name" type="text" value="" />
                </div>
                <div className="mb-3">
                  <input id="username" name="username" className="form-control" placeholder="Username" type="text" value="" />
                </div>
                <div className="mb-3">
                  <input id="age" name="age" className="form-control" placeholder="Your Age" type="number" value="" />
                </div>
                <div className="mb-3">
